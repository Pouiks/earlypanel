    ...
    <section className="brief-section" id="brief">
      <div className="brief-inner">
        <div className="brief-left">
          ...
          <p>{glossify("Quelques infos suffisent. On revient vers vous sous 24h pour caler un appel et préciser ce qui peut être testé, comment, et avec quels profils.")}</p>
          <div className="brief-guarantees">
            ...
            <div className="brief-guarantee">
              <div className="bg-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#0A7A5A" strokeWidth="2.5" strokeLinecap="round"><path d="M9 11l3 3L22 4" /></svg></div>
              <p className="bg-text"><strong>Devis sous 48h</strong>, personnalisé selon votre brief.</p>
            </div>
            <div className="brief-guarantee">
              <div className="bg-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#0A7A5A" strokeWidth="2.5" strokeLinecap="round"><path d="M9 11l3 3L22 4" /></svg></div>
            ...
            <div className="brief-guarantee">
              <div className="bg-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#0A7A5A" strokeWidth="2.5" strokeLinecap="round"><path d="M9 11l3 3L22 4" /></svg></div>
              <p className="bg-text"><strong>Paiement échelonné.</strong> 50 % à la commande, 50 % à la remise du rapport.</p>
            </div>
          </div>
        </div>
        <BriefForm />
