  ...
  return (
    <section className="usecases">
      <div className="uc-inner">
        ...
        <p className="sec-sub">{glossify("Quel que soit le moment où vous nous appelez, voici les formats qu'on teste à distance. Si votre support n'est pas dans cette liste, écrivez-nous, on regardera ensemble.")}</p>
        <div className="uc-grid">
          <div className="uc-card">
            ...
            <p>{glossify("Pourquoi développer si on n'est pas sûr du design ? Vous nous partagez le lien Figma, on l'intègre dans le questionnaire, et les testeurs naviguent dedans avant que vous ne lanciez la prod.")}</p>
          ...
          <div className="uc-card">
            ...
            <p>{glossify("Vous avez une URL de pré-prod prête à être éprouvée ? On y envoie les testeurs avec des credentials dédiés (créés pour l'occasion, supprimés après le test).")}</p>
          ...
          <div className="uc-card">
            ...
            <p>{glossify("Votre SaaS est live mais vous voulez comprendre pourquoi le taux de conversion d'un parcours est en dessous de vos attentes. On cible la zone précise (checkout, onboarding, dashboard) sans toucher à vos données réelles.")}</p>
          ...
          <div className="uc-card">
            ...
            <p>{glossify("iOS, Android, TestFlight, APK : on choisit les testeurs en fonction de leur appareil réel. Pas de simulation desktop quand vous testez une app mobile.")}</p>
          ...
          <div className="uc-card">
            ...
            <p>{glossify("Vos CGU sont compréhensibles par un humain non-juriste ? Votre formulaire d'inscription décourage la moitié des visiteurs ? On le mesure.")}</p>
          ...
          <div className="uc-card">
            ...
            <p>{glossify("Là où ça abandonne, là où ça bloque, là où le client trouve le bouton mais hésite à cliquer. On observe et on documente, vous corrigez.")}</p>
