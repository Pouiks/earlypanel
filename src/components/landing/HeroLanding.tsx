      ...
      <div className="hero-index">
        <div>
          ...
          <p className="hero-sub-index">
            On commence par comprendre ce que vous voulez vraiment savoir. Ensuite on sélectionne les profils qui correspondent à votre cible. Le questionnaire, on l&apos;écrit avec vous. Et les testeurs répondent — vraiment, sans cocher des cases.
          </p>
