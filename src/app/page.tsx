...
const faqHomepage = [
  ...
  {
    q: "Pourquoi choisir earlypanel plutôt qu'une plateforme de tests en libre-service ou qu'un freelance UX ?",
    a: "Face à une plateforme en libre-service, trois différences. (1) Recrutement des testeurs à la main : on lit chaque profil un par un selon vos critères. (2) Co-construction du questionnaire : quelqu'un de l'équipe l'écrit avec vous et le relit pour qu'il ne guide pas les réponses. (3) Rapport rédigé et restitution en visioconférence, au lieu de réponses brutes à analyser vous-même. C'est un service de test UX, pas un outil que vous configurez seul. Face à un freelance UX research, la différence est le panel : il doit recruter les testeurs dans son réseau ou le vôtre ; nous les avons déjà, profils complets et sélectionnés pour la mission, et le rapport arrive cinq jours ouvrés après le lancement.",
  },
  {
    q: "earlypanel est-il disponible hors de France ?",
    a: "Notre panel testeurs est exclusivement basé en France métropolitaine, avec un IBAN requis pour les paiements. Côté entreprise cliente, nous pouvons travailler avec des sociétés européennes ou internationales qui ciblent un marché français. L'infrastructure (base de données, stockage des documents, NDA signés) est hébergée en région européenne et soumise au RGPD : aucune donnée personnelle ne quitte l'UE.",
  },
  {
