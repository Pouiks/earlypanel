...
const faqB2B = [
  ...
  { q: "Que se passe-t-il si les résultats ne sont pas exploitables ?", a: "Si à l'issue du test l'ensemble des retours ne permet pas de tirer de conclusions claires (ce qui est rare avec un brief bien cadré), on relance gratuitement une vague de tests sur d'autres profils. Notre travail commence à l'atelier de cadrage : si on a bien fait ce travail-là, ça n'arrive pas." },
];
